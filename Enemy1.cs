...
public class Enemy1 : MonoBehaviour{
    ...
    void Update(){
        /*if ( (transform.position.x >-48) &&  (transform.position.x <42) && (transform.position.y) > -15 && (transform.position.y < -39) ) {
            canBeDestroyed = false;// daca e in aceste coordonate nu se poate distruge
        }else {
            Destroy(gameObject);
        }*/
